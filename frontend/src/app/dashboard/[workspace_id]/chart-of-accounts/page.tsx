...
export default function ChartOfAccountsPage({ params }: { params: Promise<{ workspace_id: string }> }) {
  ...
  const handleAddNew = () => {
    router.push(`/dashboard/${workspaceId}/chart-of-accounts/new`);
  };

  const handleEdit = (id: string) => {
    router.push(`/dashboard/${workspaceId}/chart-of-accounts/${id}`);
  };
                  ...
                  {chartOfAccounts.map((chart) => {
                    ...
                    return (
                      <TableRow key={chart.id}>
                        ...
                        <TableCell>
                          <Link href={`/dashboard/${workspaceId}/chart-of-accounts/${chart.id}`} className="text-blue-600 hover:underline">
                            {chart.name}
                          </Link>
                        </TableCell>
                        <TableCell>
