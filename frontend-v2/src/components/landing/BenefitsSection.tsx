      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-700">
            {currentLocale === "zh"
              ? "来自使用 AutoBooks 的真实会计师的真实结果"
              : currentLocale === "fr"
              ? "Des résultats réels de comptables réels utilisant AutoBooks"
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              {currentLocale === "zh"
                ? "在日常记账上"
                : currentLocale === "fr"
                ? "sur la comptabilité de routine"
